	...
	public class Global : HttpApplication
	{
        ...
        internal static IEnumerable<Models.ChainSettings> Chains
        {
            get
            {
                ...
                chains.Add(new Models.ChainSettings() { Name = "gbst", Host = "http://139.59.100.99", Port = 2666, RPCUser = "multichainrpc", RPCPassword = "AnmRTrf9C2hWm7RZCBAwSvwrXeuqSkS61FroAAcgSk4v" });
